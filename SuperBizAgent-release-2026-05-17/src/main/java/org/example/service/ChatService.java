...
import org.example.agent.tool.WeatherTools;
...
public class ChatService {
    ...
    public String buildSystemPrompt(List<Map<String, String>> history) {
        ...
        // 基础系统提示
        systemPromptBuilder.append("你是一个专业的智能助手，可以获取当前时间、查询实时天气信息、搜索内部文档知识库，以及查询 Prometheus 告警信息。\n");
        systemPromptBuilder.append("当用户询问时间相关问题时，使用 getCurrentDateTime 工具。\n");
        systemPromptBuilder.append("当用户询问天气相关问题时（如某城市天气、温度、是否下雨等），使用 queryWeather 工具查询实时天气，支持中英文城市名称。\n");
