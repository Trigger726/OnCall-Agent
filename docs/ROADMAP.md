...
- 检查点 40 部分通过：从已持久化的固定集评测运行展示版本/引擎隔离的历史质量，不把稀疏线上复核误当生产命中率。本地 H2 118 项发现/104 项执行、前端 13 项、JAR 与桌面/390px 实页已通过，真实 MySQL/远端 CI 待验。详见 [验收记录](acceptance/V1.7-checkpoint-40.md)。
